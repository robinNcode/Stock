	...
	<div class="home-two-style">
						...
						<div class="row">
							...
							<div class="col-lg-6 text-md-center">
								<figure class="hero-image">
									<img src="http://robin.adovasoft.com/Beginningworks/IMG_20191104_130019_419.JPG" alt="image Not Found">
								</figure>
							</div>
						</div>
					</div>
		...
		<footer class="footer-section">
			<div class="container text-center">
				<div class="copyright">
Copyright &copy;<script>document.write(new Date().getFullYear());</script>Robin & Sajib
</div>
			</div>
		</footer>
		<!-- Footer section end -->
